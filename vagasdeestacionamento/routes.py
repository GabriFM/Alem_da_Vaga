...
from vagasdeestacionamento.forms import FormLogin, FormCriarConta, FormEditarPerfil
...
from vagasdeestacionamento.camera import Estacionamento

@app.route('/status', methods=['GET'])
def get_status():
    return jsonify(estacionamento.get_status())
