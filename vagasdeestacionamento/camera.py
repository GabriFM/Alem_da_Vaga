...
class Estacionamento:
    def __init__(self):
        self.vaga1 = [1, 100, 150, 220, True]
        self.vaga2 = [157, 100, 150, 220, False]
        self.vaga3 = [313, 100, 150, 220, True]
        self.vagas = [self.vaga1, self.vaga2, self.vaga3]
        self.disponibilidade_vagas = []
    ...
    def get_status(self):
        return self.vaga1[4], self.vaga2[4], self.vaga3[4]
    def get_status2(self):
        print(self.vaga1[4], self.vaga2[4], self.vaga3[4])
